...
Rust lockfiles plus the GUI npm lockfile, sorted by package URL, and intentionally contain neither a timestamp
nor a generated UUID. Re-running
...
The CI supply-chain job audits those exact lockfiles, scans complete Git history
locally for secrets, and tests the generator twice for deterministic output.
Its exception policy is documented in
