...
/// How many versions back this build still serves. Protocol 8 adds GPU
/// guest frames and protocol 7 added storage authority fences; keep the
/// unnumbered protocol-1 release reachable in a rolling orbit.
